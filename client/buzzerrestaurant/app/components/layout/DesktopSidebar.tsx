...
const getActiveItem = (pathname: string | null): string => {
  if (!pathname) return 'Restaurants';
  
  if (pathname === '/') return 'Restaurants';
  if (pathname.startsWith('/featured-products')) return 'Featured Products';
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="hidden md:flex fixed right-0 top-0 bottom-0 w-80 z-50 overflow-y-auto flex-col"
